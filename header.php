				...
				<?php }else{ ?>
					<div class="tool tool-me">
						<a href="<?= theme_cache::get_author_posts_url(theme_cache::get_current_user_id());?>">
							<img class="avatar" width="32" height="32" src="http://www.sousouhaole.com/wp-content/uploads/avatars/avatar-1.png" alt="avatar">&nbsp; <i class="fa fa-caret-down"></i>
						</a>
						<div class="box">
							<!-- points -->
								...
								<?php if(class_exists('theme_custom_point')){ ?>
									<a href="<?= theme_custom_user_settings::get_tabs('history')['url'];?>">
										<?php if(theme_custom_point::get_point_img_url()){ ?>
											<img src="http://www.sousouhaole.com/wp-content/uploads/avatars/avatar-1.png" alt="" width="16" height="16">
										<?php }else{ ?>
