...
echo '<p>SHARE IN&nbsp;<a href="http://www.yuanmawu.net/" target="_blank"><red><span style="border: 1px solid rgb(0, 0, 0); color: rgb(255, 0, 0);"><strong>源码下载</strong></span></red></a></p>';
}
...
function h_add_dashboard_widgets() {
    wp_add_dashboard_widget('example_dashboard_widget', '一影福利最新电影', 'dashboard_custom_feed_output');
}
